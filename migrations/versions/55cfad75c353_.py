...
Revision ID: 55cfad75c353
Revises: None
Create Date: 2016-10-20 13:31:35.316673

"""

# revision identifiers, used by Alembic.
revision = '55cfad75c353'
down_revision = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('DruhPapiru', sa.String(), nullable=False),
    sa.Column('Cena', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_papir'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_papir_Cena', 'papir', ['Cena'], unique=False)
    op.create_index('ix_papir_DruhPapiru', 'papir', ['DruhPapiru'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_papir_DruhPapiru', table_name='papir')
    op.drop_index('ix_papir_Cena', table_name='papir')
    op.drop_table('papir')
